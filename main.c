...
int main(void)
{
  /* USER CODE BEGIN 1 */
	int adcvalue=5000;
	uint8_t var[] = "Welcome Here\r\n";  // Added newline for better readability
	uint8_t msg[] = "ZERO THROTTLE\r\n";  // Added newline for better readability
	uint8_t msg1[] = "ECONOMY\r\n";  // Added newline for better readability
	uint8_t msg2[] = "MAXIMUM\r\n";  // Added newline for better readability
	uint8_t msg4[] = "TOP SPEED\r\n";  // Added newline for better readability
